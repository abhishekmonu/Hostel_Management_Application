...
import kotlinx.android.synthetic.main.activity_admin_changepassword.*
...
class admin_changepassword : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        admin_save.setOnClickListener{
            ...
            {
                var database2 = FirebaseDatabase.getInstance().getReference(enrollment.toString())
                    ...
                    if(it.exists()) {
                        ...
                        if(cpassword.equals(currentpassword.text.toString()))
                        {
                            if(newpassword.text.toString().equals(confirmpassword.text.toString()))
                            {
                                ...
                                var intent = Intent(this,admin_menu::class.java)
